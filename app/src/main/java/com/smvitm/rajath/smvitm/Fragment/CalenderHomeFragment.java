...
public class CalenderHomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calender_home, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AcedemicCalenderFragment(), "Acedemic Calender");
        adapter.addFragment(new CalenderHolidayFragment(), "Holidays");
