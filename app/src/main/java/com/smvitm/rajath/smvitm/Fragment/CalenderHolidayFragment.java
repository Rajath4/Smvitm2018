 ...
 */
public class CalenderHolidayFragment extends Fragment {


    public CalenderHolidayFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            is = getActivity().getAssets().open("smvitm_holiday.json");
            obj = "holiday";
        ...
        final CalenderRecyclerViewAdapter itemsAdapter = new CalenderRecyclerViewAdapter(CalenderHolidayFragment.this.getActivity(), pname, null);
