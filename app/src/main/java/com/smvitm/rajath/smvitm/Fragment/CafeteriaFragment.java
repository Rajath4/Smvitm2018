...
import com.smvitm.rajath.smvitm.Adapter.CafeteriaRecycleViewAdapter;
...
public class CafeteriaFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            InputStream is;
            String obj;
            is = CafeteriaFragment.this.getActivity().getAssets().open("smvitm_cafeteria_menu.json");
            obj = "SMVITMCafeteria";
        ...
        final CafeteriaRecycleViewAdapter itemsAdapter = new CafeteriaRecycleViewAdapter(CafeteriaFragment.this.getActivity(), pname, null);
        final RecyclerView clv = (RecyclerView) view.findViewById(R.id.clist);
        clv.setLayoutManager(new LinearLayoutManager(CafeteriaFragment.this.getActivity()));
